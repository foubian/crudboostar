...
<body
    class="  @php echo (Session::get('theme_color'))?:'skin-blue'; echo ' '; echo config('crudbooster.ADMIN_LAYOUT'); @endphp  sidebar-mini">
                    ...
                    <div class="hex" style="width: 34.64px;height: 40px;background:DarkGray;">
                        <div class="hex-background" style="width: 30.64px;height: 36px;  background: #ecf0f5;">
                            <div class="overlayhex">
                                ...
                                <a class="iconhex spin-icon" title='{{ $ib['label'] }}' href='{{ $ib['url'] }}' id='{{ str_slug($ib['label']) }}'
                                ...
                                @if ($ib['onLoad']) onLoad='return {{ $ib['onLoad'] }}' @endif>
                                    <span class="spin-icon">
                                    <i class='{{ $ib['icon'] }}' style="color: {{ $ib['color']}}"></i>
                                    </span>
                                </a>
                            </div>
                        </div>

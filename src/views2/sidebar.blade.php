...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu tree" data-widget="tree">
            ...
            @if ($dashboard)
                <li data-id='{{ $dashboard->id }}' class="{{ Request::is(config('crudbooster.ADMIN_PATH')) ? 'active' : '' }}"><a href='{{ CRUDBooster::adminPath() }}'
            ...
            @if (CRUDBooster::isSuperadmin())
                ...
                <li class='treeview'>
                    ...
                    <ul class='treeview-menu'>
                        <li class="{{ Request::is(config('crudbooster.ADMIN_PATH') . '/privileges/add*') ? 'active' : '' }}">
                            <a href='{{ Route('PrivilegesControllerGetAdd') }}'>{{ $current_path }}<i class='fa fa-plus'></i>
                ...
                <li class='treeview'>
                    <a href='#'><i class='fa fa-dashboard'></i> <span>{{ cbLang('Statistic_Builder') }}</span>
                        <span class="pull-right-container">
                            <i class="fa fa-angle-{{ cbLang('left') }} pull-{{ cbLang('left') }}"></i>
                        </span>
                    </a>
                ...
                <li class='treeview'>
                    <a href='#'>
                        ...
                        <span class="pull-right-container"><i class="fa fa-angle-{{ cbLang('left') }} pull-{{ cbLang('left') }}"></i>
                        </span>
                    </a>
                    <ul class='treeview-menu'>
                ...
                <li class='treeview'>
                    <a href='#'><i class='fa fa-envelope'></i><span>{{ cbLang('Email_Templates') }}</span>
                        <span class="pull-right-container">
                            <i class="fa fa-angle-{{ cbLang('left') }} pull-{{ cbLang('left') }}"></i>
                        </span>
                    </a>
                ...
                <li class="{{ Request::is(config('crudbooster.ADMIN_PATH') . '/logs*') ? 'active' : '' }}"><a href='{{ Route('LogsControllerGetIndex') }}'><i class='fa fa-flag'></i>

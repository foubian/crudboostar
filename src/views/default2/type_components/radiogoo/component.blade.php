        ...
        @if ($form['dataenum'] != '')
            ...
            <div id="radios">
                @foreach ($dataenum as $k => $d)
                    ...
                    ?>
                    <style type="text/css">
                        input[type="radio"].color{{ $color }}:checked+span {
                            color: #fdfefe;
                            background-color: {{ $color }};
                        }

                        #radios label.{{ $color }}:hover::before {
                            content: attr(for);
                            color:  {{ $color }};
                        }
                    </style>

                    <label for="{{ $label }}" class="{{ $color }}">
                        <input type="radio" class="color{{ $color }}" {{ $disabled }} {{ $checked }}
